...
The allowlist does not pre-approve MPL-2.0, EPL-2.0, LGPL or GPL. Existing
dependencies are a baseline; Dependency Review evaluates additions and changes,
so an update involving one of those licenses will stop for explicit review.
